...
public class StdDesignDocumentFactory implements DesignDocumentFactory {
  ...
  private Map<String, String> createUpdateHandlerFunctions(final Class<?> metaDataClass) {
    ...
    ReflectionUtils
        .eachAnnotation(metaDataClass, UpdateHandler.class, new Predicate<UpdateHandler>() {
          @Override
    ...
    ReflectionUtils
        .eachAnnotation(metaDataClass, UpdateHandlers.class, new Predicate<UpdateHandlers>() {
          @Override
  ...
  private Map<String, String> createListFunctions(final Class<?> metaDataClass) {
    ...
    ReflectionUtils
        .eachAnnotation(metaDataClass, ListFunction.class, new Predicate<ListFunction>() {
          @Override
