...
public final class HttpStatus {
  ...
  /**
   * Request was accessing a non-existent URL. For example, if you have a malformed URL, or are
   * using a third party library that is targeting a different version of CouchDB.
   */
