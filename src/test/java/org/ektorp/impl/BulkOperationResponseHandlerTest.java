...
public class BulkOperationResponseHandlerTest {
  ...
  public void testSuccessHttpResponse() throws Exception {
    List<TestDoc> objects = Arrays
        .asList(new TestDoc("0", "rev0"), new TestDoc("1", "rev1"), new TestDoc("2", "rev2"));
    BulkOperationResponseHandler h = new BulkOperationResponseHandler(objects, new ObjectMapper());

    List<DocumentOperationResult> errors = h
        .success(ResponseOnFileStub.newInstance(202, "bulk_response.json"));
