...
public class ContinuousChangesFeedTest {
  ...
  public void setUp() throws Exception {
    ...
    feed = new ContinuousChangesFeed("testDB",
        ResponseOnFileStub.newInstance(200, testStream, "application/json", change.length()));
  }
  ...
  public void when_feed_is_cancelled_all_threads_should_be_interrupted()
  ...
  public void illegalStateExcetion_should_be_thrown_when_feed_is_cancelled()
      throws IOException, InterruptedException {
    feed.cancel();
    Thread.sleep(100);
    feed.next();
  ...
  @Test
  @Ignore("fails intermittently")
  public void when_exception_occurrs_all_threads_should_be_interrupted()
      throws IOException, InterruptedException {
