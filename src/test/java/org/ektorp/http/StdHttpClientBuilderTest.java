...
public class StdHttpClientBuilderTest {
  ...
  /**
   * This test documents that the configureHttpParams() should be protected so that it can be
   * overridden by applications who need to configure the HttpParams instance before it is given to
