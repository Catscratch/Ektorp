...
public class ViewQueryTest {
  ...
  public void keys_should_encode_ints_properly() {
    ViewQuery.Keys keys = ViewQuery.Keys
  ...
  public void complex_start_end_key() throws Exception {
    String url = query.startKey(ComplexKey.of(2010, 8, 3)).endKey(ComplexKey.of(2010, 12, 24))
        .buildQuery();
...
//			.viewName("viewname")
  ...
  public void call_list_function_with_params() {
    ...
    assertEquals(
        "/db/_design/examples/_list/index-posts/posts-by-tag?param1=value1&param2=val%2Fue", url);
  }
