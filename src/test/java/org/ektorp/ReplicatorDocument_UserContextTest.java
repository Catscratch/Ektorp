...
public class ReplicatorDocument_UserContextTest {
  ...
  @Test
  public void getUnknownFields_should_return_an_empty_map_if_there_were_no_fields_which_were_not_mapped()
      throws IOException {
    ...
    ReplicatorDocument.UserContext document = objectMapper
        .readValue(jsonString, ReplicatorDocument.UserContext.class);
