...
public class DesignDocumentTest {
  ...
  public void setup() {
    ...
    dd.addView("all", new DesignDocument.View(
        "function(doc) { if (doc.Type == 'TestDoc')  emit(null, doc.id) }"));
    dd.addView("by_lastname", new DesignDocument.View(
        "function(doc) { if (doc.Type == 'TestDoc')  emit(doc.LastName, doc) }"));
    DesignDocument.View view = new DesignDocument.View();
    view.setAnonymous("module",
        "exports.info = {artiest : {name : 'artiest', properties : {naam : {name : 'naam', type : 'string', required : true, searchable : true}}}}");
    dd.addView("lib", view);
  ...
  @Test
  public void should_deserialize_from_design_doc_json_from_db()
  ...
  public void should_deserialize_with_auto_detect_getters_disabled()
      throws JsonParseException, JsonMappingException, IOException {
    ObjectMapper om = new ObjectMapper();
  ...
  @Test
  public void should_serialize_just_fine()
      throws JsonParseException, JsonMappingException, IOException {
    ObjectMapper om = new ObjectMapper();
  ...
  @Test
  @SuppressFBWarnings("RV_RETURN_VALUE_IGNORED_NO_SIDE_EFFECT")
  public void should_serialize_with_auto_detect_getters_disabled()
      throws JsonParseException, JsonMappingException, IOException {
    ObjectMapper om = new ObjectMapper();
    om.getSerializationConfig().with(MapperFeature.AUTO_DETECT_GETTERS);
    assertSerialization(om);
