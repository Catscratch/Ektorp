...
public class PageRequestTest {
  ...
  public void testFromLinkWithNullKey() {
    PageRequest item = PageRequest
        ...
        .page(1).build();
    assertEquals(
        "org.ektorp.PageRequest(pageSize=5,page=1,back=false,nextKey=org.ektorp.PageRequest$KeyIdPair(key=null,docId=65f996f8b1024f00a81ef10264459a1d))",
        item.toString());
  }
  ...
  public void shouldToStringWorkWhenOnlyFirstPageIsSet() {
    ...
    assertEquals("org.ektorp.PageRequest(pageSize=5,page=0,back=false,nextKey=null)",
        item.toString());
  }
  ...
  public void shouldToStringWorkWithKeyAndDocId() {
    PageRequest item = PageRequest
        ...
        .page(1).build();
    assertEquals(
        "org.ektorp.PageRequest(pageSize=5,page=1,back=false,nextKey=org.ektorp.PageRequest$KeyIdPair(key=\"exampleKey\",docId=65f996f8b1024f00a81ef10264459a1d))",
        item.toString());
  }
  ...
  public void shouldToStringWorkWithKeyButNullDocId() {
    PageRequest item = PageRequest
        ...
        .page(1).build();
    assertEquals(
        "org.ektorp.PageRequest(pageSize=5,page=1,back=false,nextKey=org.ektorp.PageRequest$KeyIdPair(key=\"exampleKey\",docId=null))",
        item.toString());
  }
  ...
  public void shouldToJsonWorkWithKeyAndDocId() {
    PageRequest item = PageRequest
        ...
        .page(1).build();
    assertEquals(
        "{\"key\":\"exampleKey\",\"id\":\"65f996f8b1024f00a81ef10264459a1d\",\"s\":5,\"b\":0,\"p\":1}",
  ...
  public void shouldReadPageLink() {
    ...
    assertEquals(
        "org.ektorp.PageRequest(pageSize=30,page=2,back=true,nextKey=org.ektorp.PageRequest$KeyIdPair(key=\"2014-10-07T10:24:54.000+0000\",docId=fa3cf5e642a79f88425885771f4026de))",
        item.toString());
  }
