...
public class ReplicationCommandTest {
  ...
  public void basic_params() throws Exception {
    ...
    String expected = IOUtils
        .toString(getClass().getResourceAsStream("basic_replication_command.json"));
  ...
  public void all_params() throws Exception {
    ...
    String actual = mapper.writeValueAsString(rc);
    String expected = IOUtils
        .toString(getClass().getResourceAsStream("full_replication_command.json"));
    assertTrue(JSONComparator.areEqual(actual, expected));
  }
  ...
  public void all_params_since_long() throws Exception {
    ...
    String expected = IOUtils
        .toString(getClass().getResourceAsStream("full_replication_with_since_command.json"));
    assertTrue(JSONComparator.areEqual(actual, expected));
  }
  ...
  public void all_params_since_string() throws Exception {
    ...
    ReplicationCommand cmd = new ReplicationCommand.Builder()
        ...
        .createTarget(true)
        .sinceSeq(
            "11521-g1AAAAEneJzLYWBgYMlgTmGQS0lKzi9KdUhJMtZLSy3KSy3RS87JL01JzCvRA3JygOqYEhmS7P___5-VwZzEwMCdlAsUY08yNU5LMTPMItaMJAcgmVSPMMYSbEyiuUlSSooJ0cbksQBJhgYgBTRpP9QoObBRJoYmxqZmBiQadQBiFMxVHmCjjNPMki2BrsoCAEvDV_I")
        .docIds(Arrays.asList("foo", "bar", "baz"))
        .queryParams(queryParams)
        .build();
    ...
    String expected = IOUtils.toString(
        getClass().getResourceAsStream("full_replication_with_since_as_cloudant_command.json"));
