...
/**
 * Follow references to other documents when loading and updating this collection based on the
...
public @interface DocumentReferences {
  ...
  /**
   * If view is left unspecified a view will be generated for this document reference (given the
   * persistent type is managed by a repository class based on org.ektorp.support.CouchDbRepositorySupport).
   * <p>
   * View name for backward references. Backward references are stored in the documents on the other
   * side of the reference. References are loaded into this collection by performing a view query
   * against the specified view with the document id of the declaring class.
   */
  ...
  /**
   * The sort order  of the loaded collection can be specified by this parameter. This parameter
   * will refer to a field in the child docs. Note: This parameter is only applied if view is not
   * specified.
   */
  public String orderBy() default "";

  /**
   * The name of the back referring field in the child must be specified here. Note: This parameter
   * is only applied if view is not specified.
   */
