...
public class ChangesCommand {
  ...
  private ChangesCommand(Builder b) {
    ...
    if (b.extraQueryParams != null) {
      extraQueryParams = Collections
          .unmodifiableMap(new LinkedHashMap<String, String>(b.extraQueryParams));
    } else {
  ...
  public static class Builder {
    ...
    /**
     * Adds a parameter to the GET request sent to the database. This is mainly used for supplying
     * parameters to filter functions.
     */
