...
public class ReplicationCommand implements Serializable {
  ...
  public static class Builder {
    ...
    /**
     * Source and target can both point at local databases, remote databases and any combination of
     * these.
     * <p>
     * If your local CouchDB instance is secured by an admin account, you need to use the full URL
     * format
     */
    ...
    /**
     * To create the target database (remote or local) prior to replication. The names of the source
     * and target databases do not have to be the same.
     */
    ...
    /**
     * The sequence from which the replication should start See http://docs.couchdb.org/en/latest/json-structure.html#replication-settings
     * for details
     * <p>
     * CouchDB expects a Long value for the sequence Cloudant expects a String value for the
     * sequence
     *
