...
/**
 * This bean is designed so that, when marshaled as JSON using Jackson, it is handled as a bulk
 * request by CouchDB.<br> Put this into a JacksonableEntity (org.apache.http.HttpEntity) in order
 * to get HttpClient to marshal it on the request stream.<br>
 */
