...
public class StreamedCouchDbConnector extends StdCouchDbConnector {
  ...
  public StreamedCouchDbConnector(String databaseName, CouchDbInstance dbi,
...

  {
    ...
    setInputStreamBulkExecutor(
        new InputStreamBulkEntityBulkExecutor(dbURI, restTemplate, objectMapper));
  }
