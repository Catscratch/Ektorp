...
public class CouchDbDocument implements Serializable {
  ...
  /**
   * Note: Will only be populated if this document has been loaded with the revisions option =
   * true.
   */
  @JsonIgnore
  ...
  /**
   * @return a list of conflicting revisions. Note: Will only be populated if this document has been
   * loaded through the CouchDbConnector.getWithConflicts method.
   */
  @JsonIgnore
