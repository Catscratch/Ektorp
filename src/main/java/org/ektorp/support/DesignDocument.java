 ...
 * <p>
 * Design documents can contain fields currently not handled by Ektorp, such as update handlers and
 * validators. These fields are still accessible through the methods getAnonymous() and
 * setAnonymous(String key, Object value)
 */
public class DesignDocument extends OpenCouchDbDocument {
  ...
  /**
   * Merge this design document with the specified document, the result being stored in this design
   * document.
   *
   * @param dd           the design document to merge with
   * @param updateOnDiff true to overwrite existing views/functions in this document with the
   *                     views/functions in the specified document; false will only add new
   *                     views/functions.
  ...
  /**
   * This method will check for the two system properties boolean {@link
   * #AUTO_UPDATE_VIEW_ON_CHANGE} and {@link #UPDATE_ON_DIFF}, then call {@link
  ...
  public static class View {
    ...
    /**
     * @return a Map containing fields that did not map to any other field in the class during
     * object deserializarion from a JSON document.
     */
    @JsonAnyGetter
