...
import static org.ektorp.util.ReflectionUtils.eachAnnotation;
import static org.ektorp.util.ReflectionUtils.eachField;
import static org.ektorp.util.ReflectionUtils.eachMethod;
import static org.ektorp.util.ReflectionUtils.findMethod;
import static org.ektorp.util.ReflectionUtils.hasAnnotation;
...
public class SimpleViewGenerator {
  ...
  public Map<String, DesignDocument.View> generateViews(
    ...
    final Class<?> handledType = repository instanceof CouchDbRepositorySupport<?>
        ? ((CouchDbRepositorySupport<?>) repository)
        .getHandledType() : null;
  ...
  public static DesignDocument.View loadViewFromString(ObjectMapper objectMapper, String json)
      throws IOException {
    return objectMapper
        .readValue(json.replaceAll(LINE_ENDING_DOS, "").replaceAll(LINE_ENDING_UNIX, ""),
