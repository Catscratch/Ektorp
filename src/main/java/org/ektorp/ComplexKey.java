...
/**
 * Class for creating complex keys for view queries. The keys's components can consists of any
 * JSON-encodeable objects, but are most likely to be Strings and Integers.
 */
