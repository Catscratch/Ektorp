...
public class Page<T> implements Iterable<T> {
  ...
  public Page(List<T> rows, long totalSize, int pageSize, PageRequest previousPageRequest,
  ...
  /**
   * Exists mainly for providing compatibility with the c:forEach in jstl (1.2) as it cannot handle
   * java.lang.Iterable
   */
